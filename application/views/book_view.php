...
<html>
    <head>
        ...
        <title>Lear PHP Codeigniter Framework with Ajax and Bootstrap</title>
        <link href="<?php echo base_url('assests/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assests/datatables/css/dataTables.bootstrap.css')?>" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function add_book() {
                save_method = 'add';
                $('#form')[0].reset(); //reset form on models
                    ...
                    <div class="modal-body form">
                        <form action="#" id="form" class="form-horizontal">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-group col-md-3">Book Title</label>
                                    <div class="col-md-9">
                                        <input name="book_title" placeholder="Book Title" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-group col-md-3">Book Author</label>
                                    <div class="col-md-9">
                                        <input name="book_author" placeholder="Book Author" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-group col-md-3">Book Category</label>
                                    <div class="col-md-9">
